    ...
    try {
        switch (name) {
            ...
            case 'recommend_b402_purchase': {
                const { wallet, expected_monthly_spend } = args;
                const tierInfo = await client.getB402Tier(wallet);
