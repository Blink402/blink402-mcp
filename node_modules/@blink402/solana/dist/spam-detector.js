...
exports.detectSpamToken = detectSpamToken;
exports.detectSpamTokens = detectSpamTokens;
...
const logger = (0, config_1.createLogger)('@blink402/spam-detector');
 ...
 */
function detectSpamToken(token) {
    const flags = [];
 ...
 */
function detectSpamTokens(tokens) {
