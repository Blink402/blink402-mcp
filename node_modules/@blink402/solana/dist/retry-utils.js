...
exports.sleep = sleep;
exports.retrySolanaRpc = retrySolanaRpc;
exports.timeout = timeout;
exports.withTimeout = withTimeout;
const config_1 = require("@blink402/config");
const logger = (0, config_1.createLogger)('@blink402/solana-retry');
/**
...
async function withExponentialBackoff(fn, options = {}) {
    const { maxRetries = 3, initialDelayMs = 1000, maxDelayMs = 30000, backoffMultiplier = 2, shouldRetry = defaultShouldRetry, onRetry = defaultOnRetry, } = options;
    let lastError;
...
function defaultShouldRetry(error, attempt) {
    ...
    if (error instanceof Error) {
        ...
        if (message.includes('insufficient') || // Insufficient funds
 ...
 */
function defaultOnRetry(error, attempt, nextDelay) {
 ...
 */
async function retrySolanaRpc(fn, operation, options = {}) {
